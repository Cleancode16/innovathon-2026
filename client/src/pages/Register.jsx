...
import { UserPlus, User, Mail, Lock, AlertCircle, GraduationCap, BookOpen, ArrowRight, Menu, X, Sparkles } from 'lucide-react';
      ...
      <div className="flex items-center justify-center p-4 relative overflow-hidden min-h-screen pt-24">
        ...
        <div className="max-w-xl w-full relative z-10">
          ...
          <motion.div
            ...
            className="bg-white rounded-3xl shadow-2xl p-6 md:p-8 border-2 border-neutral-200 relative overflow-hidden"
          >
            {/* Gradient Accent */}
            ...
            <div className="text-center mb-6">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-black mb-2">Create Account</h2>
              <p className="text-neutral-600">Join us and start your learning journey</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    value={formData.role}
                    onChange={handleChange}
                    className="block w-full pl-12 pr-10 py-3.5 border-2 border-neutral-200 rounded-xl focus:ring-2 focus:ring-lime-300 focus:border-lime-300 transition-all bg-white text-black appearance-none cursor-pointer font-medium"
                  >
              ...
              <motion.button
                ...
                className="w-full bg-black text-lime-300 py-4 px-6 rounded-xl font-bold text-lg hover:bg-neutral-800 focus:outline-none focus:ring-2 focus:ring-lime-300 focus:ring-offset-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg flex items-center justify-center gap-2 mt-2"
              >
                {loading ? (
